  ...
  experiences: [
    {
      ...
      bullets: [
        ...
        "Developed interactive and accessible web pages from Figma designs, ensuring responsiveness across devices using React.js and Vue.js.",
        "Built React components using Test-Driven Development (TDD) principles with Jest for unit testing.",
    ...
    },
    {
      ...
      bullets: [
        ...
        "Proactively addressed WCAG issues to improve web content accessibility, ensuring full compliance, resulting in a 10% increase in product usage by users with disabilities.",
